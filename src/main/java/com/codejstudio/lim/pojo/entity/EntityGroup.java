...
public class EntityGroup extends Entity implements IGroupable<Entity> {
	...
	private Collection<Entity> innerGroupCollection;
	 ...
	 */
	public EntityGroup() throws LIMException {
		super();
	}

	public EntityGroup(boolean ifInitId) throws LIMException {
		super(ifInitId, true);
	}

	public EntityGroup(boolean ifInitId, Entity... entities) throws LIMException {
		super(ifInitId, true);
	...
	@Override
	public Collection<Entity> getInnerGroupCollection() {
	...
	@Override
	public boolean containGroupElement(Entity element) throws LIMException{
		return (this.innerGroupCollection != null) 
				? this.innerGroupCollection.contains(element) : false;
	}

	@Override
	public boolean addGroupElement(Entity... elements) throws LIMException {
		return addGroupElement(CollectionUtil.generateCollection(elements));
	}

	@Override
	public boolean addGroupElement(Collection<Entity> elements) throws LIMException {
	...
	@Override
	public boolean removeGroupElement(Entity... elements) throws LIMException {
		return removeGroupElement(CollectionUtil.generateCollection(elements));
	}

	@Override
	public boolean removeGroupElement(Collection<Entity> elements) throws LIMException {
		if(CollectionUtil.checkNullOrEmpty(elements) 
	...
	private void reloadFromRootElementMap(Map<String, AbstractElement> rootElementMap) throws LIMException {
		...
		for (BaseElement be : c) {
			if(be != null && be.getId() != null) {
				...
				if(ae != null && ae instanceof Entity) {
					Entity element = (Entity) ae;
					this.innerGroupCollection.add(element);
				}
			}
		}
	...
	@Override
	public EntityGroup cloneElement() throws LIMException {
		EntityGroup cloneElement = (EntityGroup) super.cloneElement();
		
		if(!CollectionUtil.checkNullOrEmpty(this.innerGroupCollection)) {
			cloneElement.initInnerGroupCollection();
			for (Entity element : this.innerGroupCollection) {
