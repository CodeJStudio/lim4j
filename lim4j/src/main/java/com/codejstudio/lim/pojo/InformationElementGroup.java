...
public class InformationElementGroup extends InformationElement implements IGroupable<InformationElement> {
	...
	private List<InformationElement> innerGroupList;
	...
	@Override
	public List<InformationElement> getInnerGroupList() {
	...
	@Override
	public boolean removeGroupElement(final InformationElement... groupElements) throws LIMException {
		return removeGroupElement((groupElements == null) ? null : Arrays.asList(groupElements));
	}

	@Override
	public boolean removeGroupElement(final Collection<? extends InformationElement> groupElementCollection) 
			throws LIMException {
		if (CollectionUtil.checkNullOrEmpty(groupElementCollection) 
	...
	@Override
	public boolean replaceGroupElement(final InformationElement replacee, final InformationElement replacer) 
			throws LIMException {
	...
	private void reloadFromRootElementMap(final Map<String, GenericElement> rootElementMap) 
		...
		for (BaseElement be : vc) {
			...
			this.innerGroupList.add((InformationElement) ge);
		}
		destroyInnerGroupList();
	}
	...
	private InformationElementGroup cloneToElement(final InformationElementGroup clonedElement, 
		...
		if (!CollectionUtil.checkNullOrEmpty(this.innerGroupList)) {
			...
			for (InformationElement element : this.innerGroupList) {
