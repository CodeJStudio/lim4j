...
public class StatementGroup extends Statement implements IGroupable<Statement> {
	...
	private List<Statement> innerGroupList;
	...
	@Override
	public List<Statement> getInnerGroupList() {
	...
	@Override
	public boolean removeGroupElement(final Statement... groupElements) throws LIMException {
		return removeGroupElement((groupElements == null) ? null : Arrays.asList(groupElements));
	}

	@Override
	public boolean removeGroupElement(final Collection<? extends Statement> groupElementCollection) 
			throws LIMException {
		if (CollectionUtil.checkNullOrEmpty(groupElementCollection) 
	...
	@Override
	public boolean replaceGroupElement(final Statement replacee, final Statement replacer) 
			throws LIMException {
	...
	private void reloadFromRootElementMap(final Map<String, GenericElement> rootElementMap) 
		...
		for (BaseElement be : vc) {
			...
			this.innerGroupList.add((Statement) ge);
		}
		destroyInnerGroupList();
	}
	...
	private StatementGroup cloneToElement(final StatementGroup clonedElement, 
		...
		if (!CollectionUtil.checkNullOrEmpty(this.innerGroupList)) {
			...
			for (Statement element : this.innerGroupList) {
