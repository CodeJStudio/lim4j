...
public class InformationElement extends AbstractRelationableInformationElement {
	...
	public boolean removeSubInformationElement(final InformationElement... elements) throws LIMException {
		return removeSubInformationElement((elements == null) ? null : Arrays.asList(elements));
	}

	public boolean removeSubInformationElement(final Collection<InformationElement> elementCollection) 
			throws LIMException {
		if (CollectionUtil.checkNullOrEmpty(elementCollection) 
				|| GroupableUtil.checkNullOrEmpty(this.subInformationElementGroup)) {
		...
		try {
			boolean flag = super.removeInnerElementDelegate(elementCollection) 
					& this.subInformationElementGroup.removeGroupElement(elementCollection);
			if (flag) {
