...
public class AffiliationRelation extends BaseRelation {
	...
	public boolean setMaster(final AbstractRelationableInformationElement master) throws LIMException {
		...
		if (super.primaryElement != null) {
			flag &= super.removeIntegratedElementDelegate(MASTER);
		}
		if (master != null) {
			flag &= super.putIntegratedElementDelegate(MASTER, new BaseElement(master));
		}
		flag &= super.setPrimaryElement(master, false);
	...
	public boolean setSlave(final AbstractRelationableInformationElement slave) throws LIMException {
		...
		if (super.secondaryElement != null) {
			flag &= super.removeIntegratedElementDelegate(SLAVE);
		}
		if (slave != null) {
			flag &= super.putIntegratedElementDelegate(SLAVE, new BaseElement(slave));
		}
		flag &= super.setSecondaryElement(slave, false);
